...
console.log('newPolicyExceptionRow approval, comments',newnewPolicyExceptionCreateRow.Policy_Exception_Definition__r.Requires_Approval__c,newnewPolicyExceptionCreateRow.Policy_Exception_Definition__r.Requires_Officer_Explanation__c);

if(newnewPolicyExceptionCreateRow.Policy_Exception_Definition__r.Requires_Approval__c && newnewPolicyExceptionCreateRow.Policy_Exception_Definition__r.Requires_Officer_Explanation__c){
...
if(!newnewPolicyExceptionCreateRow){
    ...
    if(newnewPolicyExceptionCreateRow.Policy_Exception_Definition__r.Requires_Approval__c){
         var newnewPolicyExceptionCreateRow = newPolicyExceptionCreate.createRow({
            additionalConditions: [
                { field: 'Status__c', value:'Pending' },
...
if(!newnewPolicyExceptionCreateRow){
    ...
    if(newnewPolicyExceptionCreateRow.Policy_Exception_Definition__r.Requires_Officer_Explanation__c && !newnewPolicyExceptionCreateRow.Officer_Comments__c){
         return displayMessage('For selected policy exception template " Officer Comments " is mandatory  ', 'ERROR');
    }


}else{
    if(newnewPolicyExceptionCreateRow.Policy_Exception_Definition__c){
        if(newnewPolicyExceptionCreateRow.Policy_Exception_Definition__r.Requires_Officer_Explanation__c && !newnewPolicyExceptionCreateRow.Officer_Comments__c){
             return displayMessage('For selected policy exception template " Officer Comments " is mandatory ', 'ERROR');
        }
    }else{
